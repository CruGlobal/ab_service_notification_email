...
## $ docker buildx build --provenance=true --sbom=true --platform linux/amd64,linux/arm64 -t digiserve/ab-notification-email:master --push .
...
LABEL org.opencontainers.image.title="Notification Email" \
   org.opencontainers.image.description="Microservice for sending and receiving emails" \
